  ...
  return (
    <div className="moderation-panel">
      ...
      <div className="moderation-toolbar">
        ...
        <select aria-label="Filter by date" value={filters.event} onChange={(event) => setFilters({ ...filters, event: event.target.value as Filters['event'] })} disabled={Boolean(mutation)}><option value="all">Both days</option><option value="solemnisation">21 August</option><option value="reception">22 August</option></select>
