...
export function GreetingModerationPanel() {
  ...
  return (
    <div className="greeting-moderation-panel">
      <div className="admin-section-heading"><div><p className="eyebrow">Guestbook</p><h1>Words worth keeping.</h1></div><p>Written wedding wishes. Only approved greetings appear in the public guestbook.</p></div>
